...
CreateConVar( "GAuto_Config_CharringTime", 120, { FCVAR_REPLICATED, FCVAR_ARCHIVE }, "How long a vehicle has to be on fire for until it becomes charred and permanently disabled. Set to -1 to disable. (Requires VFire)" )
CreateConVar( "GAuto_Config_ExplodeRemoveTime", 600, { FCVAR_REPLICATED, FCVAR_ARCHIVE }, "Time it takes in seconds for a destroyed vehicle to get removed. Set to -1 to disable." )
